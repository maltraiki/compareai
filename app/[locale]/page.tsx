  ...
  try {
    ...
    t = (key: string) => {
      const translations: any = {
        'header.title': 'CompareAI',
        'header.subtitle': 'Your Personal Shopping Expert',
        'chat.online': 'Alex is Online',
        'header.reviews': '(12,847 reviews)',
        'hero.badge': '#1 AI Shopping Assistant • Saves You Money',
        'hero.title': 'Meet Alex',
        'hero.subtitle': 'Your Personal Shopping Expert',
        'hero.description': 'Hi! I\'m Alex, your personal shopping expert. I\'ve helped 50,000+ people save money by finding the perfect products at the best prices. Let me help you make smart buying decisions!',
        'hero.instantAnalysis': 'Instant Analysis',
        'hero.bestPrices': 'Best Prices',
        'hero.unbiasedAdvice': 'Unbiased Advice',
        'stats.happyShoppers': 'Happy Shoppers',
        'stats.moneySaved': 'Money Saved',
        'stats.productsCompared': 'Products Compared',
        'stats.averageRating': 'Average Rating',
        'sections.trending': 'Trending Comparisons Right Now',
        'sections.hot': 'HOT',
        'sections.viewed': 'views',
        'sections.compare': 'Compare Now',
        'sections.justCompared': 'Just Compared by Other Shoppers',
        'sections.autoGenerated': 'AUTO-GENERATED',
        'sections.autoGeneratedFromChat': 'Auto-generated from chat',
        'sections.view': 'View',
        'reviews.title': 'What Happy Shoppers Say',
        'reviews.review1': 'Alex helped me save $500 on my new laptop! The comparison was so detailed and easy to understand.',
        'reviews.reviewer1': '- Sarah M., Verified Buyer',
        'reviews.review2': 'I always check with Alex before making any tech purchase. It\'s like having a tech expert friend!',
        'reviews.reviewer2': '- John D., Tech Enthusiast',
        'reviews.review3': 'The side-by-side comparisons are amazing. Helped me choose the perfect phone for my needs.',
        'reviews.reviewer3': '- Maria L., Happy Customer',
        'why.title': 'Why Choose CompareAI?',
        'why.aiTitle': 'AI-Powered Analysis',
        'why.aiDesc': 'Our AI analyzes thousands of reviews and specs to give you the most accurate comparisons.',
        'why.saveTitle': 'Save Money',
        'why.saveDesc': 'We find the best deals and show you exactly where to get the lowest prices.',
        'why.instantTitle': 'Instant Results',
        'why.instantDesc': 'Get comprehensive comparisons in seconds, not hours of research.',
        'why.ctaTitle': 'Ready to Save Money on Your Next Purchase?',
        'why.ctaDesc': 'Join 50,000+ smart shoppers who trust Alex for their buying decisions.',
        'why.ctaButton': 'Start Comparing Now - It\'s Free!',
        'footer.copyright': '© 2024 CompareAI. Your trusted shopping companion.',
